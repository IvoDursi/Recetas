  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Classic Veganized", style: TextStyle(color: Colors.tealAccent[700], fontWeight: FontWeight.bold)),
      ),
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      if (snapshot.hasData) {
        ...
        Iterable<Receta> receta = recet.where((re) => re.categoria == "Classics Veganized").toList().reversed;
