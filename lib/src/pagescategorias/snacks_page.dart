  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: Text("Snacks", style: TextStyle(color: Colors.tealAccent[700], fontWeight: FontWeight.bold)),
      ),
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      ...
      if (snapshot.hasData) {
        ...
        Iterable<Receta> receta = recet.where((re) => re.categoria == "Snacks").toList().reversed;
